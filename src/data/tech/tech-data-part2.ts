...
export const pythonData: TechItem[] = [
  ...
  { category: '终端美化', tech: 'Rich / Colorama / Termcolor / Blessed', popular: 'Rich', description: '终端富文本渲染与美化' },
  { category: 'TUI框架', tech: 'Textual / urwid / npyscreen / asciimatics', popular: 'Textual', description: '终端用户界面应用框架' },
